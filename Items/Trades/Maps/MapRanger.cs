		...
		public static void MapSetup( MapRanger paper )
		{
			if ( Utility.RandomMinMax( 1, 3 ) > 1 )
			{
				switch ( Utility.Random( 71 ) )
				{
					...
					case 16: paper.m_MapDestination = "Pirate Cave"; paper.m_MapDest = Map.Sosaria; paper.m_PointDest = new Point3D(1842, 2211, 0); break;
			...
			else
			{
				...
				{
					case 0: paper.m_MapDestination = "the Lost Glade"; paper.m_MapDest = Map.Sosaria; paper.m_PointDest = new Point3D(3910, 3971, 0); break;
