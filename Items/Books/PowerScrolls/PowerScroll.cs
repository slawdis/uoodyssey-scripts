...
namespace Server.Items
{
	public class PowerScroll : SpecialScroll
	{
		...
		public static Item RandomPowerScroll()
		{
			...
			if ( roll >= 95 ){ choice = Utility.RandomMinMax( 192, 239 ); }
			else if ( roll >= 85 ){ choice = Utility.RandomMinMax( 144, 191 ); }
			else if ( roll >= 70 ){ choice = Utility.RandomMinMax( 96, 143 ); }
			else if ( roll >= 50 ){ choice = Utility.RandomMinMax( 48, 95 ); }
