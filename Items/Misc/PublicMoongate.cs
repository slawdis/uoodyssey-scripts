...
namespace Server.Items
{
	...
	public class PMList
	{
		...
		public static readonly PMList Sosaria =
			new PMList( 1012000, 1012012, Map.Sosaria, new PMEntry[]
				{
		...
		public static readonly PMList Lodor =
			new PMList( 1012001, 1012013, Map.Lodor, new PMEntry[]
				{
					new PMEntry( new Point3D( 4467, 1283, 5 ), 1012003 ), // Elidor
					new PMEntry( new Point3D( 1336, 1997, 5 ), 1012004 ), // Britain
					new PMEntry( new Point3D( 1499, 3771, 5 ), 1012005 ), // DevilGuard
		...
		public static readonly PMList Underworld =
			new PMList( 1012002, 1012014, Map.Underworld, new PMEntry[]
				{
		...
		public static readonly PMList SerpentIsland =
			new PMList( 1060643, 1062039, Map.SerpentIsland, new PMEntry[]
				{
					new PMEntry( new Point3D( 1015,  527, -65 ), 1060641 ), // Luna
					new PMEntry( new Point3D( 1997, 1386, -85 ), 1060642 )  // Umbra
				} );

		public static readonly PMList IslesDread =
			new PMList( 1063258, 1063415, Map.IslesDread, new PMEntry[]
				{
		...
		public static readonly PMList[] AOSLists		= new PMList[] { Sosaria, Lodor, Underworld, SerpentIsland };
		public static readonly PMList[] AOSListsYoung	= new PMList[] { Sosaria, Underworld, SerpentIsland };
		public static readonly PMList[] SELists			= new PMList[] { Sosaria, Lodor, Underworld, SerpentIsland, IslesDread };
		public static readonly PMList[] SEListsYoung	= new PMList[] { Sosaria, Underworld, SerpentIsland, IslesDread };
