    ...
    public class DungeonMastersGuide : Item
	{
		...
		public class DMGuideGump : Gump
		{
			public DMGuideGump(): base( 25, 25 )
			{
				...
				AddHtml( 170, 68, 249, 73, @"<BODY><BASEFONT Color=#FCFF00><BIG>This book contains a listing of almost all of the dungeons in the many worlds of Ultima Odyssey.</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
