	...
	public class Cargo : Item
	{
		...
		public void CreateCargo()
		{
			...
			else if ( CargoType == 38 )
			{
				...
				switch( CargoMaterial )
				{
					case 1: Name = "agility"; 					CargoContains = "AgilityPotion"; 				CargoQty = (int)(CargoValue/30); 	break;
					case 2: Name = "greater agility"; 			CargoContains = "GreaterAgilityPotion"; 		CargoQty = (int)(CargoValue/60); 	break;
					case 3: Name = "conflagration"; 			CargoContains = "ConflagrationPotion"; 			CargoQty = (int)(CargoValue/30); 	break;
					case 4: Name = "greater conflagration"; 	CargoContains = "GreaterConflagrationPotion"; 	CargoQty = (int)(CargoValue/60); 	break;
					case 5: Name = "confusion blast"; 			CargoContains = "ConfusionBlastPotion"; 		CargoQty = (int)(CargoValue/30); 	break;
					case 6: Name = "greater confusion blast"; 	CargoContains = "GreaterConfusionBlastPotion"; 	CargoQty = (int)(CargoValue/60); 	break;
					case 7: Name = "lesser cure"; 				CargoContains = "LesserCurePotion"; 			CargoQty = (int)(CargoValue/15); 	break;
					case 8: Name = "cure"; 						CargoContains = "CurePotion"; 					CargoQty = (int)(CargoValue/30); 	break;
					case 9: Name = "greater cure"; 				CargoContains = "GreaterCurePotion"; 			CargoQty = (int)(CargoValue/60); 	break;
					case 10: Name = "lesser explosion"; 		CargoContains = "LesserExplosionPotion"; 		CargoQty = (int)(CargoValue/15); 	break;
					case 11: Name = "explosion"; 				CargoContains = "ExplosionPotion"; 				CargoQty = (int)(CargoValue/30); 	break;
					case 12: Name = "greater explosion"; 		CargoContains = "GreaterExplosionPotion"; 		CargoQty = (int)(CargoValue/60); 	break;
					case 13: Name = "frostbite"; 				CargoContains = "FrostbitePotion"; 				CargoQty = (int)(CargoValue/30); 	break;
					case 14: Name = "greater frostbite"; 		CargoContains = "GreaterFrostbitePotion"; 		CargoQty = (int)(CargoValue/60); 	break;
					case 15: Name = "lesser heal"; 				CargoContains = "LesserHealPotion"; 			CargoQty = (int)(CargoValue/15); 	break;
					case 16: Name = "heal"; 					CargoContains = "HealPotion"; 					CargoQty = (int)(CargoValue/30); 	break;
					case 17: Name = "greater heal"; 			CargoContains = "GreaterHealPotion"; 			CargoQty = (int)(CargoValue/60); 	break;
					case 18: Name = "night sight"; 				CargoContains = "NightSightPotion"; 			CargoQty = (int)(CargoValue/15); 	break;
					case 19: Name = "lesser poison"; 			CargoContains = "LesserPoisonPotion"; 			CargoQty = (int)(CargoValue/15); 	break;
					case 20: Name = "poison"; 					CargoContains = "PoisonPotion"; 				CargoQty = (int)(CargoValue/30); 	break;
					case 21: Name = "greater poison"; 			CargoContains = "GreaterPoisonPotion"; 			CargoQty = (int)(CargoValue/60); 	break;
					case 22: Name = "deadly poison"; 			CargoContains = "DeadlyPoisonPotion"; 			CargoQty = (int)(CargoValue/70); 	break;
					case 23: Name = "lethal poison"; 			CargoContains = "LethalPoisonPotion"; 			CargoQty = (int)(CargoValue/80); 	break;
					case 24: Name = "refresh"; 					CargoContains = "RefreshPotion"; 				CargoQty = (int)(CargoValue/30); 	break;
					case 25: Name = "total refresh"; 			CargoContains = "TotalRefreshPotion"; 			CargoQty = (int)(CargoValue/60); 	break;
					case 26: Name = "strength"; 				CargoContains = "StrengthPotion"; 				CargoQty = (int)(CargoValue/30); 	break;
					case 27: Name = "greater strength"; 		CargoContains = "GreaterStrengthPotion"; 		CargoQty = (int)(CargoValue/60); 	break;
				}
