	...
	public class MagicHat : GoldRing
	{
		...
		public MagicHat()
		{
			...
			switch ( myHat ) 
			{
				...
				case 24: ItemID = 0x310; Name = "wizard cowl"; break;
				case 25: ItemID = 0x405; Name = "mask of the dead"; break;
				case 26: ItemID = 0x4CDB; Name = "reaper hood"; break;
				case 27: ItemID = 0x4CDD; Name = "reaper cowl"; break;
				case 28: ItemID = 0x4D01; Name = "daemon cowl"; break;
				case 29: ItemID = 0x4D02; Name = "lizard cowl"; break;
				case 30: ItemID = 0x4D03; Name = "evil hood"; break;
				case 31: ItemID = 0x4D04; Name = "evil cowl"; break;
				case 32: ItemID = Utility.RandomList( 0x141B, 0x141C ); Name = "orcish mask"; break;
				case 33: ItemID = Utility.RandomList( 0x2B72, 0x3169 ); Name = "gargoyle mask"; break;
			}

			if ( myHat < 18 ){ Hue = Utility.RandomColor(0); }
