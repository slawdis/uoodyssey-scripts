		...
		private class WearTarget : Target
		{
			...
			protected override void OnTarget( Mobile from, object targeted )
			{
				...
				else if ( iWear is BaseArmor && Server.Misc.MaterialInfo.IsAnyKindOfMetalItem( iWear ) )
				{
					...
					else if ( iWear.ItemID == 0x1410 || iWear.ItemID == 0x1417 ){ DoEffects = true; iWear.ItemID = 0x303; NewName = "platemail arms"; }
					else if ( iWear.ItemID == 0x303 ){ DoEffects = true; iWear.ItemID = 0x304; NewName = "platemail arms"; }
					else if ( iWear.ItemID == 0x304 ){ DoEffects = true; iWear.ItemID = 0x305; NewName = "platemail arms"; }
					else if ( iWear.ItemID == 0x305 ){ DoEffects = true; iWear.ItemID = 0x306; NewName = "platemail arms"; }
					else if ( iWear.ItemID == 0x306 ){ DoEffects = true; iWear.ItemID = 0x2B0A; NewName = "royal arms"; }
