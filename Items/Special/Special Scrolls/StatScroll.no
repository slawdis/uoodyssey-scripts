...
namespace Server.Items
{
	public class StatCapScroll : SpecialScroll
	{
		...
		public override string DefaultTitle { get { return String.Format( "<basefont Color=#FBFBFB>Power Scroll ({0}{1} Maximum Stats):</basefont>", ( (int)Value - 225 ) >= 0 ? "+" : "", (int)Value - 225 ); } }
