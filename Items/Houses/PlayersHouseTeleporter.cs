    ...
    public class PlayersHouseTeleporter : Item, IDyable, ISecurable
	{
		...
		{            
            ...
            else if ( m_Active )
			{
				...
				//	return true;
				//}
				else if ( m.Skills[SkillName.Magery].Base < 80.0 && m.Skills[SkillName.Necromancy].Base < 80.0 && m_MapDest == Map.Sosaria && thisX > 5798 && thisY > 2727 && thisX < 6105 && thisY < 3023 ) // TO STOP TRAVEL TO THE MOON
				{
