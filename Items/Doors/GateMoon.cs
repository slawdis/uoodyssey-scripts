		...
		public class MoonGateGump : Gump
		{
			...
			public override void OnResponse( NetState state, RelayInfo info )
			{
				...
				if ( info.ButtonID > 0 )
				{
					...
					else if (gate6){gX = 3907; gY = 3962; gZ = 5; map = Map.Sosaria;  }
					else if (gate7){gX = 2548; gY = 2685; gZ = 4; map = Map.Sosaria;  }
					else if (gate8){gX = 963; gY = 514; gZ = 4; map = Map.Sosaria;  }
					else if (gate9){gX = 1052; gY = 1570; gZ = 2; map = Map.Sosaria;  }
					else if (gate10){gX = 1792; gY = 913; gZ = 27; map = Map.Sosaria;  }
					else if (gate11){gX = 968; gY = 2726; gZ = 4; map = Map.Sosaria;  }
					else if (gate12){gX = 4038; gY = 179; gZ = 2; map = Map.Sosaria;  }
					else if (gate13){gX = 6092; gY = 3595; gZ = 4; map = Map.Sosaria;  }
					else if (gate14){gX = 1249; gY = 3815; gZ = 2; map = Map.Sosaria;  }
					else if (gate15){gX = 1017; gY = 546; gZ = 3; map = Map.IslesDread;  }
					else if (gate16){gX = 4199; gY = 2516; gZ = 7; map = Map.Lodor;  }
					else if (gate17){gX = 2497; gY = 1981; gZ = 5; map = Map.Lodor;  }
					else if (gate18){gX = 1045; gY = 2258; gZ = 6; map = Map.Lodor;  }
					else if (gate19){gX = 2350; gY = 3619; gZ = 6; map = Map.Lodor;  }
					else if (gate20){gX = 4276; gY = 1841; gZ = 16; map = Map.Lodor;  }
					else if (gate21){gX = 719; gY = 962; gZ = 6; map = Map.Lodor;  }
					else if (gate22){gX = 2876; gY = 733; gZ = 9; map = Map.Lodor;  }
					else if (gate23){gX = 1163; gY = 411; gZ = 5; map = Map.SerpentIsland;  }
					else if (gate24){gX = 1300; gY = 1372; gZ = 5; map = Map.SerpentIsland;  }
					else if (gate25){gX = 234; gY = 1333; gZ = 3; map = Map.SerpentIsland;  }
					else if (gate26){gX = 656; gY = 240; gZ = 3; map = Map.SavagedEmpire;  }
					else if (gate27){gX = 1112; gY = 1710; gZ = 20; map = Map.SavagedEmpire;  }
					else if (gate28){gX = 303; gY = 1269; gZ = 3; map = Map.SavagedEmpire;  }
					else if (gate29){gX = 6603; gY = 1082; gZ = 2; map = Map.Sosaria;  }
					else if (gate30){gX = 6377; gY = 302; gZ = 15; map = Map.Lodor;  }
