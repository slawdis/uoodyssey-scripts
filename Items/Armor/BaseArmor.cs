		...
		public virtual double ArmorRating
		{
			get
			{
				...
				switch ( m_Resource )
				{
					...
					case CraftResource.Nepturite:		ar += 16; break;
					case CraftResource.Obsidian:		ar += 16; break;
					case CraftResource.Steel:			ar += 18; break;
					case CraftResource.Brass:			ar += 20; break;
					case CraftResource.Mithril:			ar += 22; break;
					case CraftResource.Xormite:			ar += 22; break;
					case CraftResource.Dwarven:			ar += 36; break;
					case CraftResource.SpinedLeather:	ar += 3; break;
					case CraftResource.HornedLeather:	ar += 4; break;
					case CraftResource.BarbedLeather:	ar += 5; break;
					case CraftResource.NecroticLeather:	ar += 6; break;
					case CraftResource.VolcanicLeather:	ar += 7; break;
					case CraftResource.FrozenLeather:	ar += 8; break;
					case CraftResource.GoliathLeather:	ar += 9; break;
					case CraftResource.DraconicLeather:	ar += 10; break;
					case CraftResource.HellishLeather:	ar += 11; break;
					case CraftResource.DinosaurLeather:	ar += 12; break;
					case CraftResource.AlienLeather:	ar += 12; break;
					case CraftResource.AshTree: 		ar += 2; break;
					case CraftResource.CherryTree: 		ar += 4; break;
					case CraftResource.EbonyTree: 		ar += 6; break;
					case CraftResource.GoldenOakTree: 	ar += 8; break;
					case CraftResource.HickoryTree: 	ar += 10; break;
					case CraftResource.MahoganyTree: 	ar += 11; break;
					case CraftResource.DriftwoodTree: 	ar += 11; break;
					case CraftResource.OakTree: 		ar += 12; break;
					case CraftResource.PineTree: 		ar += 13; break;
					case CraftResource.GhostTree: 		ar += 13; break;
					case CraftResource.RosewoodTree: 	ar += 14; break;
					case CraftResource.WalnutTree: 		ar += 15; break;
					case CraftResource.PetrifiedTree: 	ar += 18; break;
					case CraftResource.ElvenTree: 		ar += 30; break;
					case CraftResource.YellowScales:	ar += 11; break;
					case CraftResource.RedScales:		ar += 12; break;
					case CraftResource.GreenScales:		ar += 13; break;
					case CraftResource.BlackScales:		ar += 14; break;
					case CraftResource.WhiteScales:		ar += 15; break;
					case CraftResource.BlueScales:		ar += 16; break;
				}
