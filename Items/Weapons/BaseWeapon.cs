...
namespace Server.Items
{
	...
	public abstract class BaseWeapon : Item, IWeapon, IFactionItem, ICraftable, ISlayer, IDurability
	{
		...
		public virtual void OnHit( Mobile attacker, Mobile defender, double damageBonus )
		{
			...
			if ( m_MaxHits > 0 && ( ( MaxRange <= 1 && ( defender is Slime || defender is Xenomorph || defender is GreenSlime || defender is BlackPudding || defender is LavaPuddle || defender is AcidPuddle || defender is ToxicElemental ) ) || Utility.Random( 25 ) == 0) ) // Stratics says 50% chance, seems more like 4%..
			{
		...
		public virtual double ScaleDamageAOS( Mobile attacker, double damage, bool checkSkills )
		{
			...
			double	ninjaBonus = GetBonus( attacker.Skills[SkillName.ArmsLore].Value,			0.625, 100.0,  6.25 );
