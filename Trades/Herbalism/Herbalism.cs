...
namespace Server.Engines.Harvest
{
	public class Herbalism : HarvestSystem
	{
		...
		private Herbalism()
		{
			...
			leaf.ConsumedPerLodorHarvest = 1;
			...
			mushroom.ConsumedPerLodorHarvest = 1;
			...
			flower.ConsumedPerLodorHarvest = 1;
			...
			cactus.ConsumedPerLodorHarvest = 1;
			...
			lilly.ConsumedPerLodorHarvest = 1;
			...
			grass.ConsumedPerLodorHarvest = 1;
