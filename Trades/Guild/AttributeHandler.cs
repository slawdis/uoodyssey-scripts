    ...
    public class AttributeHandler
    {
        ...
        public static void Initialize()
        {
            ...
            Definitions.Add(new AttributeHandler(EnhanceType.AosAttribute, "BonusMana", "Mana Increase", 							20, 1, 5,
                armor, !weapon, !jewelry, spellbook, !shield, clothing));
            Definitions.Add(new AttributeHandler(EnhanceType.AosAttribute, "LowerManaCost", "Lower Mana Cost", 						50, 1, 5,
                armor, !weapon, jewelry, spellbook, !shield, clothing));
            Definitions.Add(new AttributeHandler(EnhanceType.AosAttribute, "LowerRegCost", "Lower Reagent Cost", 					50, 1, 5,
                armor, !weapon, jewelry, spellbook, !shield, clothing));
