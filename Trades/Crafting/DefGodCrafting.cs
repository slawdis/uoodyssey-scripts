...
namespace Server.Engines.Craft
{
	...
	public class DefGodSewing : CraftSystem
	{
		...
		public override int CanCraft( Mobile from, BaseTool tool, Type itemType )
		{
			...
			if ( from.Map == Map.SavagedEmpire && from.X > 1087 && from.X < 1105 && from.Y > 1968 && from.Y < 1982 )
				return 0;
	...
	public class DefGodBrewing : CraftSystem
	{
		...
		public override int CanCraft( Mobile from, BaseTool tool, Type itemType )
		{
			...
			if ( from.Map == Map.SavagedEmpire && from.X > 1098 && from.X < 1121 && from.Y > 1908 && from.Y < 1931 )
				return 0;
