				...
				if ( winner != null )
				{
					...
					if ( winner is PlayerMobile && !winner.Blessed )
					{
						...
						if ( p != null )
						{
							...
							{
								if ( pmi.Mobile is PlayerMobile && pmi.Mobile.InRange(this.Location, 20) && pmi.Mobile.Map == this.Map && !pmi.Mobile.Blessed && pmi.Mobile.StatCap < 300 && !Server.Items.CharacterDatabase.GetSpecialsKilled( pmi.Mobile, "TitanStratos" ) )
								{
						...
						else if ( winner.StatCap < 300 && !Server.Items.CharacterDatabase.GetSpecialsKilled( winner, "TitanStratos" ) )
						{
