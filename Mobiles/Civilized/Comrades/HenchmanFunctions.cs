    ...
    class HenchmanFunctions
    {
		...
		public static string GetTitle()
		{
			...
			switch ( Utility.RandomMinMax( 0, 105 ) )
			{
				...
				case 33: myTitle = "the Fearless"; if (Utility.RandomBool()){myTitle = "the Brave";} break;
				case 34: myTitle = "the Savage"; if (Utility.RandomBool()){myTitle = "the Civilized";} break;
				...
				case 47: myTitle = "the Strong"; if (Utility.RandomBool()){myTitle = "the Weak";} break;
				...
				case 60: myTitle = "the Calm"; if (Utility.RandomBool()){myTitle = "the Frantic";} break;
				case 61:
				...
				case 69: myTitle = "the Masked"; if (Utility.RandomBool()){myTitle = "the Veiled";} break;
				case 70: myTitle = "the Merciful"; if (Utility.RandomBool()){myTitle = "the Merciless";} break;
				...
				case 75: myTitle = "the Mysterious"; if (Utility.RandomBool()){myTitle = "the Unknown";} break;
				case 76: myTitle = "the Obscure"; break;
				case 77: myTitle = "the Old"; if (Utility.RandomBool()){myTitle = "the Young";} break;
				...
				case 82: myTitle = "the Quick"; if (Utility.RandomBool()){myTitle = "the Slow";} break;
				...
				case 90: myTitle = "the Short"; if (Utility.RandomBool()){myTitle = "the Tall";} break;
				...
				case 97: myTitle = "the Traveler"; if (Utility.RandomBool()){myTitle = "the Wanderer";} break;
				case 98: myTitle = "the Wary"; break;
				case 99: myTitle = "the Weird"; break;
				case 100: myTitle = "the Steady"; if (Utility.RandomBool()){myTitle = "the Unready";} break;
				case 101: myTitle = "the Gentle"; if (Utility.RandomBool()){myTitle = "the Cruel";} break;
				case 102: myTitle = "the Lost"; if (Utility.RandomBool()){myTitle = "the Exiled";} break;
				case 103: myTitle = "the Careless"; if (Utility.RandomBool()){myTitle = "the Clumsy";} break;
				case 104: myTitle = "the Hopeful"; if (Utility.RandomBool()){myTitle = "the Trustful";} break;
				case 105: myTitle = "the Angry"; if (Utility.RandomBool()){myTitle = "the Timid";} break;
			}
			return myTitle;
		}
