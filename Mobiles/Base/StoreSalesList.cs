...
namespace Server.Mobiles
{
	...
	public class SBElfRares: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( Futon ), Utility.Random( 1000,5000 ), 1, 0x295C, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( ArtifactVase ), Utility.Random( 1000,5000 ), 1, 0x0B48, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( ArtifactLargeVase ), Utility.Random( 1000,5000 ), 1, 0x0B47, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BrokenBookcaseDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BrokenBedDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BrokenArmoireDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( StandingBrokenChairDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BrokenVanityDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BrokenFallenChairDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BrokenCoveredChairDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BrokenChestOfDrawersDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TapestryOfSosaria ), Utility.Random( 1000,5000 ), 1, 0x234E, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( RoseOfMoon ), Utility.Random( 1000,5000 ), 1, 0x234C, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( HearthOfHomeFireDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( VanityDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BlueDecorativeRugDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BlueFancyRugDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BluePlainRugDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BoilingCauldronDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( CinnamonFancyRugDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( CurtainsDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( FountainDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( GoldenDecorativeRugDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( HangingAxesDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( HangingSwordsDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( HouseLadderDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( LargeFishingNetDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( PinkFancyRugDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( RedPlainRugDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( ScarecrowDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SmallFishingNetDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TableWithBlueClothDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TableWithOrangeClothDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TableWithPurpleClothDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TableWithRedClothDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( UnmadeBedDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( WallBannerDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TreeStumpDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( DecorativeShieldDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( MiningCartDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( PottedCactusDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( StoneAnkhDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( BannerDeed ), Utility.Random( 1000,5000 ), 1, 0x14F0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( Tub ), Utility.Random( 1000,5000 ), 1, 0xe83, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( WaterBarrel ), Utility.Random( 1000,5000 ), 1, 0xe77, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( ClosedBarrel ), Utility.Random( 1000,5000 ), 1, 0x0FAE, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( Bucket ), Utility.Random( 1000,5000 ), 1, 0x14e0, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( DecoTray ), Utility.Random( 1000,5000 ), 1, 0x992, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( DecoTray2 ), Utility.Random( 1000,5000 ), 1, 0x991, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( DecoBottlesOfLiquor ), Utility.Random( 1000,5000 ), 1, 0x99E, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( Checkers ), Utility.Random( 1000,5000 ), 1, 0xE1A, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( Chessmen3 ), Utility.Random( 1000,5000 ), 1, 0xE14, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( Chessmen2 ), Utility.Random( 1000,5000 ), 1, 0xE12, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( Chessmen ), Utility.Random( 1000,5000 ), 1, 0xE13, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( Checkers2 ), Utility.Random( 1000,5000 ), 1, 0xE1B, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( DecoHay2 ), Utility.Random( 1000,5000 ), 1, 0xF34, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( DecoBridle2 ), Utility.Random( 1000,5000 ), 1, 0x1375, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( DecoBridle ), Utility.Random( 1000,5000 ), 1, 0x1374, 0 ) ); }
			}
		}
	...
	public class SBLeatherArmor: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LeatherCloak ), 120, Utility.Random( 1,15 ), 0x1515, 0x83F ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LeatherRobe ), 160, Utility.Random( 1,15 ), 0x1F03, 0x83F ) ); }
	...
	public class SBMetalShields : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BronzeShield ), 66, Utility.Random( 1,15 ), 0x1B72, 0 ) ); }
	...
	public class SBPlateArmor: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( PlateLegs ), 218, Utility.Random( 1,15 ), 0x1411, 0 ) ); }
	...
	public class SBSEBowyer: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Yumi ), 53, Utility.Random( 1,15 ), 0x27A5, 0 ) ); }
				...
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( Bokuto ), 21, Utility.Random( 1,15 ), 0x27A8, 0 ) ); }
			}
		}
	...
	public class SBSELeatherArmor: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LeatherNinjaPants ), 49, Utility.Random( 1,15 ), 0x2791, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LeatherNinjaJacket ), 51, Utility.Random( 1,15 ), 0x2793, 0 ) ); }
	...
	public class SBAxeWeapon: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( OrnateAxe ), 42, Utility.Random( 1,15 ), 0x2D28, 0 ) ); }
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				if ( MyServerSettings.BuyChance() ){Add( typeof( OrnateAxe ),21 ); } // DO NOT WANT?
	...
	public class SBSpearForkWeapon: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Pitchfork ), 19, Utility.Random( 1,15 ), 0xE87, 0xB3A ) ); }
	...
	public class SBAlchemist : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			...
			{  
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( MixingSpoon ), 34, Utility.Random( 1,15 ), 0x1E27, 0x979 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( CBookNecroticAlchemy ), 50, Utility.Random( 1,15 ), 0x2253, 0x4AA ) ); }
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BookOfPoisons ), 50, Utility.Random( 1,15 ), 0x2253, 0x4F8 ) ); }

				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( Bottle ), 5, Utility.Random( 1,15 ), 0xF0E, 0 ) ); } 
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( Jar ), 5, Utility.Random( 1,15 ), 0x10B4, 0 ) ); } 
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( MixingCauldron ), 123 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( MixingSpoon ), 17 ); } // DO NOT WANT? 
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( Bottle ), 3 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( Jar ), 3 ); } // DO NOT WANT?
	...
	public class SBArchitect : SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( PlayersHouseTeleporter ), 4000 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PlayersZTeleporter ), 2000 ); } // DO NOT WANT?
	...
	public class SBSailor : SBInfo
	{
		...
		{ 
			...
			{ 
				...
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( SwordsAndShackles ), 50, Utility.Random( 1,15 ), 0x529D, 0 ) ); }
	...
	public class SBBarkeeper : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Dices ), 2, Utility.Random( 1,15 ), 0xFA7, 0 ) ); }
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{ 	
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( IronIngot ), 5, Utility.Random( 1,15 ), 0x1BF2, 0 ) ); }
		...
		{ 
			public InternalSellInfo() 
			{
				if ( MyServerSettings.BuyChance() ){Add( typeof( TopazIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( ShinySilverIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( AmethystIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( EmeraldIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( GarnetIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( IceIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( JadeIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( MarbleIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( OnyxIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( QuartzIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( RubyIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( SapphireIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( SpinelIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( StarRubyIngot ), 120 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( Tongs ), 7 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( IronIngot ), 4 ); } // DO NOT WANT? 
	...
	public class SBCarpenter: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Board ), 3, Utility.Random( 1,15 ), 0x1BD7, 0 ) ); }
				...
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( CounterFancy ), Utility.Random( 200,400 ), Utility.Random( 1,5 ), 0x544F, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( CounterWood ), Utility.Random( 200,400 ), Utility.Random( 1,5 ), 0x5451, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( CounterWooden ), Utility.Random( 200,400 ), Utility.Random( 1,5 ), 0x5453, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( CounterStained ), Utility.Random( 200,400 ), Utility.Random( 1,5 ), 0x5455, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( CounterPolished ), Utility.Random( 200,400 ), Utility.Random( 1,5 ), 0x5457, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( CounterRustic ), Utility.Random( 200,400 ), Utility.Random( 1,5 ), 0x5459, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( CounterDark ), Utility.Random( 200,400 ), Utility.Random( 1,5 ), 0x545B, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( CounterLight ), Utility.Random( 200,400 ), Utility.Random( 1,5 ), 0x545D, 0 ) ); }
			}
		}
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( AshLog ), 2 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( CherryLog ), 2 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( EbonyLog ), 3 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( GoldenOakLog ), 3 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( HickoryLog ), 4 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( MahoganyLog ), 4 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( DriftwoodLog ), 4 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( OakLog ), 5 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PineLog ), 5 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( GhostLog ), 5 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( RosewoodLog ), 6 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( WalnutLog ), 6 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( ElvenLog ), 12 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PetrifiedLog ), 7 ); } // DO NOT WANT?

				if ( MyServerSettings.BuyChance() ){Add( typeof( Board ), 2 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( AshBoard ), 3 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( CherryBoard ), 3 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( EbonyBoard ), 4 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( GoldenOakBoard ), 4 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( HickoryBoard ), 5 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( MahoganyBoard ), 5 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( DriftwoodBoard ), 5 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( OakBoard ), 6 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PineBoard ), 6 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( GhostBoard ), 6 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( RosewoodBoard ), 7 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( WalnutBoard ), 7 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( ElvenBoard ), 14 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PetrifiedBoard ), 8 ); } // DO NOT WANT?
			}
		}
	}
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{ 
		...
		{ 
			...
			{ 	
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LeatherSandals ), 60, Utility.Random( 1,15 ), 0x170d, 0x83E ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LeatherShoes ), 75, Utility.Random( 1,15 ), 0x170f, 0x83E ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LeatherBoots ), 90, Utility.Random( 1,15 ), 0x170b, 0x83E ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( LeatherThighBoots ), 105, Utility.Random( 1,15 ), 0x1711, 0x83E ) ); }  
			} 
		} 
	...
	{ 
		...
		{ 
			...
			{ 
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( GardenTool ), 12, Utility.Random( 1,15 ), 0xDFD, 0x84F ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( HerbalistCauldron ), 247, 1, 0x2676, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( MixingSpoon ), 34, Utility.Random( 1,15 ), 0x1E27, 0x979 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Jar ), 5, Utility.Random( 1,15 ), 0x10B4, 0 ) ); }
				if ( MyServerSettings.SellRareChance() ){Add( new GenericBuyInfo( typeof( CBookDruidicHerbalism ), 50, Utility.Random( 1,15 ), 0x2D50, 0 ) ); }
			} 
		} 
		...
		{ 
			...
			{ 
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfStew ), 1 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( WoodenBowlOfTomatoSoup ), 1 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( GardenTool ), 6 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( HerbalistCauldron ), 123 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( MixingSpoon ), 17 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PlantHerbalism_Leaf ), Utility.Random( 3,7 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PlantHerbalism_Flower ), Utility.Random( 3,7 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PlantHerbalism_Mushroom ), Utility.Random( 3,7 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PlantHerbalism_Lilly ), Utility.Random( 3,7 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PlantHerbalism_Cactus ), Utility.Random( 3,7 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( PlantHerbalism_Grass ), Utility.Random( 3,7 ) ); } // DO NOT WANT?
			} 
		} 
	} 
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{ 
		...
		{ 
			...
			{ 
				...
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MegalodonTooth ), Utility.RandomMinMax( 500, 2000 ) ); } // DO NOT WANT?
			} 
		} 
	} 
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	{ 
		...
		{ 
			public InternalSellInfo() 
			{ 
				if ( MyServerSettings.BuyChance() ){Add( typeof( UnicornSkin ), 30 ); } // DO NOT WANT? 
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( DemonSkin ), 40 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( DragonSkin ), 50 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( NightmareSkin ), 30 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( SerpentSkin ), 10 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( TrollSkin ), 20 ); } // DO NOT WANT? 
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( Hides ), 2 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( SpinedHides ), 3 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( HornedHides ), 3 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( BarbedHides ), 4 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( NecroticHides ), 4 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( VolcanicHides ), 5 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( FrozenHides ), 5 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( GoliathHides ), 6 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( DraconicHides ), 6 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( HellishHides ), 7 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( DinosaurHides ), 7 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( AlienHides ), 7 ); } // DO NOT WANT? 

				if ( MyServerSettings.BuyChance() ){Add( typeof( Leather ), 3 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( SpinedLeather ), 4 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( HornedLeather ), 4 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( BarbedLeather ), 5 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( NecroticLeather ), 5 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( VolcanicLeather ), 6 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( FrozenLeather ), 6 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( GoliathLeather ), 7 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( DraconicLeather ), 7 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( HellishLeather ), 8 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( DinosaurLeather ), 8 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( AlienLeather ), 8 ); } // DO NOT WANT? 
			} 
		} 
	}
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	public class SBGlassblower : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Bottle ), 5, Utility.Random( 1,15 ), 0xF0E, 0 ) ); } 
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( Jar ), 5, Utility.Random( 1,15 ), 0x10B4, 0 ) ); } 
	...
	public class SBHealer : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellRareChance() ){Add( new GenericBuyInfo( typeof( SurgeonsKnife ), 14, Utility.Random( 1,15 ), 0xEC4, 0x1B0 ) ); }
			}
		}
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( Garlic ), 2 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( Ginseng ), 2 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( SurgeonsKnife ), 7 ); } // DO NOT WANT?
	...
	{ 
		...
		{ 
			...
			{ 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Ginseng ), 3, Utility.Random( 1,15 ), 0xF85, 0 ) ); } 
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( Garlic ), 3, Utility.Random( 1,15 ), 0xF84, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( MandrakeRoot ), 3, Utility.Random( 1,15 ), 0xF86, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Nightshade ), 3, Utility.Random( 1,15 ), 0xF88, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Bloodmoss ), 5, Utility.Random( 1,15 ), 0xF7B, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( MortarPestle ), 8, Utility.Random( 1,15 ), 0x4CE9, 0 ) ); }
	...
	public class SBHolyMage : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BlankScroll ), 5, Utility.Random( 1,15 ), 0x0E34, 0 ) ); }
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( BlankScroll ), 3 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyCommonChance() ){Add( typeof( MysticalPearl ), 250 ); } // DO NOT WANT?

				Type[] types = Loot.RegularScrollTypes;

				for ( int i = 0; i < types.Length; ++i )
					if ( MyServerSettings.BuyChance() ){Add( types[i], ((i / 8) + 2) * 5 ); } // DO NOT WANT?
	...
	public class SBMapmaker : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( BlankScroll ), 12, Utility.Random( 1,15 ), 0xEF3, 0 ) ); }
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				if ( MyServerSettings.BuyChance() ){Add( typeof( BlankScroll ), 6 ); } // DO NOT WANT?
	...
	public class SBRealEstateBroker : SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( BlankScroll ), 2 ); } // DO NOT WANT?
			}
		}
	}
	///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public class SBSage: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LoreGuidetoAdventure ), 5, Utility.Random( 5,15 ), 0x1C11, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( WeaponAbilityBook ), 5, Utility.Random( 1,15 ), 0x2254, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnLeatherBook ), 5, Utility.Random( 1,15 ), 0x4C60, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnMiscBook ), 5, Utility.Random( 1,15 ), 0x4C5D, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnMetalBook ), 5, Utility.Random( 1,15 ), 0x4C5B, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnWoodBook ), 5, Utility.Random( 1,15 ), 0x4C5E, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnReagentsBook ), 5, Utility.Random( 1,15 ), 0x4C5E, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnGraniteBook ), 5, Utility.Random( 1,15 ), 0x4C5C, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnScalesBook ), 5, Utility.Random( 1,15 ), 0x4C60, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnTailorBook ), 5, Utility.Random( 1,15 ), 0x4C5E, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnTraps ), 5, Utility.Random( 1,15 ), 0xFF2, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( SwordsAndShackles ), 50, Utility.Random( 1,15 ), 0x529D, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( CBookDruidicHerbalism ), 50, Utility.Random( 1,15 ), 0x2D50, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( CBookNecroticAlchemy ), 50, Utility.Random( 1,15 ), 0x2253, 0x4AA ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( AlchemicalElixirs ), 50, Utility.Random( 1,15 ), 0x2219, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( AlchemicalMixtures ), 50, Utility.Random( 1,15 ), 0x2223, 0 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( BookOfPoisons ), 50, Utility.Random( 1,15 ), 0x2253, 0x4F8 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( WorkShoppes ), 50, Utility.Random( 1,15 ), 0x2259, 0xB50 ) ); }
				if ( 1 > 0 ){Add( new GenericBuyInfo( typeof( LearnTitles ), 5, Utility.Random( 1,15 ), 0xFF2, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( ScribesPen ), 8, Utility.Random( 1,15 ), 0x2051, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BlankScroll ), 5, Utility.Random( 1,15 ), 0x0E34, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Monocle ), 24, Utility.Random( 1,25 ), 0x543B, 0 ) ); }
	...
	public class SBShipwright : SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				if ( MyServerSettings.BuyChance() ){Add( typeof( SeaShell ), 58 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( DockingLantern ), 29 ); } // DO NOT WANT?
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( BoatStain ), 13 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MegalodonTooth ), Utility.RandomMinMax( 500, 2000 ) ); } // DO NOT WANT?
			}
		}
	}
	...
	public class SBStoneCrafter : SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( BlackStaff ), 24 ); } // DO NOT WANT?
	...
	public class SBTailor: SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( AssassinShroud ), 29 ); } // DO NOT WANT?
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( BoltOfCloth ), 50 ); } // DO NOT WANT?
	...
	{ 
		...
		{ 
			public InternalSellInfo() 
			{
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( Board ), 1 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( Log ), 1 ); } // DO NOT WANT?
	...
	public class SBVagabond : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( GoldEarrings ), 27, Utility.Random( 1,15 ), 0x4CFB, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Board ), 3, Utility.Random( 1,15 ), 0x1BD7, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( IronIngot ), 6, Utility.Random( 1,15 ), 0x1BF2, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( StarSapphire ), 125, Utility.Random( 1,15 ), 0xF21, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Emerald ), 100, Utility.Random( 1,15 ), 0xF10, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Sapphire ), 100, Utility.Random( 1,15 ), 0xF19, 0 ) ); }
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Ruby ), 75, Utility.Random( 1,15 ), 0xF13, 0 ) ); }
		...
		public class InternalSellInfo : GenericSellInfo
		{
			...
			{
				if ( MyServerSettings.BuyChance() ){Add( typeof( Board ), 1 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( IronIngot ), 3 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( Amber ), 25 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( Amethyst ), 50 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( Citrine ), 25 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( Diamond ), 100 ); } // DO NOT WANT?
	...
	public class SBVarietyDealer : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( DecoTray ), Utility.Random( 1000,5000 ), 1, 0x992, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( DecoTray2 ), Utility.Random( 1000,5000 ), 1, 0x991, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TreasurePile01AddonDeed ), Utility.Random( 8000,12000 ), 1, 0x0E41, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TreasurePile02AddonDeed ), Utility.Random( 8000,12000 ), 1, 0x0E41, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TreasurePile03AddonDeed ), Utility.Random( 8000,12000 ), 1, 0x0E41, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TreasurePile04AddonDeed ), Utility.Random( 8000,12000 ), 1, 0x0E41, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TreasurePile05AddonDeed ), Utility.Random( 8000,12000 ), 1, 0x0E41, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TreasurePileAddonDeed ), Utility.Random( 12000,20000 ), 1, 0x0E41, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TreasurePile2AddonDeed ), Utility.Random( 12000,20000 ), 1, 0x0E41, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TreasurePile3AddonDeed ), Utility.Random( 12000,20000 ), 1, 0x0E41, 0 ) ); }
			}
		}
	...
	{ 
		...
		{ 
			...
			{ 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( Dyes ), 8, Utility.Random( 1,15 ), 0xFA9, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( DyeTub ), 8, Utility.Random( 1,15 ), 0xFAB, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( UncutCloth ), 3, Utility.Random( 1,15 ), 0x1761, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( UncutCloth ), 3, Utility.Random( 1,15 ), 0x1762, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( UncutCloth ), 3, Utility.Random( 1,15 ), 0x1763, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( UncutCloth ), 3, Utility.Random( 1,15 ), 0x1764, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BoltOfCloth ), 100, Utility.Random( 1,15 ), 0xf9B, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BoltOfCloth ), 100, Utility.Random( 1,15 ), 0xf9C, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BoltOfCloth ), 100, Utility.Random( 1,15 ), 0xf96, 0 ) ); } 
				if ( MyServerSettings.SellChance() ){Add( new GenericBuyInfo( typeof( BoltOfCloth ), 100, Utility.Random( 1,15 ), 0xf97, 0 ) ); } 
		...
		{ 
			...
			{ 
				...
				if ( MyServerSettings.BuyChance() ){Add( typeof( Dyes ), 4 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( DyeTub ), 4 ); } // DO NOT WANT? 
				if ( MyServerSettings.BuyChance() ){Add( typeof( UncutCloth ), 1 ); } // DO NOT WANT?
				if ( MyServerSettings.BuyChance() ){Add( typeof( BoltOfCloth ), 50 ); } // DO NOT WANT? 
	...
	public class SBMage : SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				...
				for ( int i = 0; i < types.Length; ++i )
					if ( MyServerSettings.BuyChance() ){Add(types[i], i + 3 + (i / 4)); } // DO NOT WANT?
			
				if ( MyServerSettings.BuyChance() ){Add( typeof( ExorcismScroll ), 1 ); } // DO NOT WANT?
	...
	public class SBBuyArtifacts: SBInfo
	{
		...
		public class InternalSellInfo : GenericSellInfo
		{
			public InternalSellInfo()
			{
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AbysmalGloves ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AcidProofRobe ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Aegis ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AngelicEmbrace ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AngeroftheGods ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Annihilation ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneArms ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneCap ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneGloves ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneGorget ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneLeggings ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneShield ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcaneTunic ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcanicRobe ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcticBeacon ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArcticDeathDealer ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmorOfFortune ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmorOfInsight ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmorOfNobility ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfAegis ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfFortune ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfInsight ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfNobility ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfTheFallenKing ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfTheHarrower ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ArmsOfToxicity ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AuraOfShadows ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BalancingDeed ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BlazeOfDeath ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BookOfKnowledge ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BowOfTheJukaKing ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BraceletOfHealth ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BraceletOfTheElements ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BraceletOfTheVile ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BreathOfTheDead ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BurglarsBandana ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Calm ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandelabraOfSouls ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CapOfFortune ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CapOfTheFallenKing ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CavortingClub ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CircletOfTheSorceress ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CoifOfBane ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CoifOfFire ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ColdBlood ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CrimsonCincture ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CrownOfTalKeesh ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DarkGuardiansChest ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DarkLordsPitchfork ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DarkNeck ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DeathsMask ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineArms ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineCountenance ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineGloves ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineGorget ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineLeggings ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DivineTunic ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DjinnisRing ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DreadPirateHat ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DupresCollar ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DupresShield ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringBoxSet ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfHealth ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfProtection ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfTheElements ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfTheMagician ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EarringsOfTheVile ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ElvenQuiver ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EmbroideredOakLeafCloak ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EnchantedTitanLegBone ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EternalFlame ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( EvilMageGloves ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FalseGodsScepter ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FangOfRactus ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FesteringWound ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Fortifiedarms ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FortunateBlades ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Frostbringer ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( FurCapeOfTheSorceress ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Fury ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GauntletsOfNobility ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GeishasObi ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GladiatorsCollar ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlassSword ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfAegis ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfCorruption ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfFortune ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfInsight ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfRegeneration ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfTheFallenKing ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfTheHarrower ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfThePugilist ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GorgetOfAegis ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GorgetOfFortune ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GorgetOfInsight ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GuantletsOfAnger ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GwennosHarp ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HatOfTheMagi ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HeartOfTheLion ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HellForgedArms ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HelmOfAegis ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HelmOfInsight ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsArmPlates ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsBreastplate ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsGloves ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsGorget ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsLegging ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolyKnightsPlateHelm ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HolySword ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersArms ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersGloves ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersGorget ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersHeaddress ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersLeggings ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HuntersTunic ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Indecency ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsArms ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsGorget ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsHelm ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsLeggings ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsResolution ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( InquisitorsTunic ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( IolosLute ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsArms ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsCollar ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsGloves ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsHelm ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsLeggings ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JackalsTunic ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JadeScimitar ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JesterHatofChuckles ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( JinBaoriOfGoodFortune ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( KamiNarisIndestructableDoubleAxe ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegacyOfTheDreadLord ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfAegis ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfBane ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfDeceit ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfEnlightenment ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LeggingsOfFire ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfFortune ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfInsight ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfNobility ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfTheFallenKing ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LegsOfTheHarrower ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LieutenantOfTheBritannianRoyalGuard ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LongShot ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LuckyEarrings ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LuckyNecklace ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LunaLance ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MadmansHatchet ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MagesBand ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MagiciansIllusion ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MagiciansMempo ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MarbleShield ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MauloftheBeast ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WizardsPants ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightBracers ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightGloves ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightHelm ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightLegs ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MidnightTunic ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MinersPickaxe ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NightsKiss ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NordicVikingSword ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NoxBow ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NoxNightlight ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( NoxRangersHeavyCrossbow ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OblivionsNeedle ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrcChieftainHelm ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrcishVisage ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrnamentOfTheMagician ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( OrnateCrownOfTheHarrower ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Pestilence ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PixieSwatter ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PolarBearMask ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PowerSurge ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Quell ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				...
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RamusNecromanticScalpel ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Retort ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RighteousAnger ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfHealth ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfTheElements ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfTheMagician ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RingOfTheVile ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTheEclipse ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTheEquinox ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTreason ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalArchersBow ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalGuardsChestplate ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalGuardsGorget ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RoyalGuardSurvivalKnife ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SamaritanRobe ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SamuraiHelm ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SerpentsFang ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowBlade ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerArms ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerCap ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerGloves ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerGorget ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerLeggings ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShadowDancerTunic ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShaMontorrossbow ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShieldOfInvulnerability ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShimmeringTalisman ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ShroudOfDeciet ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SoulSeeker ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SpiritOfTheTotem ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SprintersSandals ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( StaffOfPower ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( StaffOfTheMagi ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Subdue ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SwiftStrike ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TalonBite ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheBeserkersMaul ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheDryadBow ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheDragonSlayer ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheRobeOfBritanniaAri ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TheTaskmaster ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TitansHammer ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemArms ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemGloves ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemGorget ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemLeggings ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemOfVoid ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TotemTunic ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TownGuardsHalberd ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfAegis ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfBane ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfFire ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfTheFallenKing ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TunicOfTheHarrower ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( VampiricDaisho ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( VioletCourage ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( VoiceOfTheFallenKing ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WarriorsClasp ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WeaponRenamingTool ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WildfireBow ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Windsong ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( WrathOfTheDryad ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( YashimotosHatsuburi ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ZyronicClaw ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				...
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PolarBearCape ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( PolarBearBoots ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Excalibur ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( KodiakBearMask ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( Stormbringer ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AchillesShield ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AchillesSpear ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( StaffofSnakes ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AilricsLongbow ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( LargeBagofHolding ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MediumBagofHolding ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SmallBagofHolding ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BagOfHolding ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BootsofHermes ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BeltofHercules ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobinHoodsFeatheredHat ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobinHoodsBow ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( AxeoftheMinotaur ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( BowofthePhoenix ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GandalfsRobe ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GandalfsHat ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GandalfsStaff ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HammerofThor ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ConansSword ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( ConansHelm ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( SinbadsSword ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GiantBlackjack ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleCold ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleFire ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandlePoison ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleEnergy ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleWizard ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( CandleNecromancer ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( TorchOfTrapFinding ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RodOfResurrection ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( RobeOfTeleportation ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( MaulOfTheTitans ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( HelmOfBrilliance ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GlovesOfDexterity ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( GemOfSeeing ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
				if ( MyServerSettings.BuyRareChance() ){Add( typeof( DaggerOfVenom ), Utility.Random( 250,2500 ) ); } // DO NOT WANT?
	...
	public class SBGemArmor: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( AmethystFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "amethyst", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( AmethystPlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "amethyst", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( AmethystPlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "amethyst", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( AmethystPlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "amethyst", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( AmethystPlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "amethyst", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( AmethystPlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "amethyst", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( AmethystPlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "amethyst", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( AmethystShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "amethyst", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( EmeraldFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "emerald", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( EmeraldPlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "emerald", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( EmeraldPlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "emerald", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( EmeraldPlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "emerald", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( EmeraldPlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "emerald", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( EmeraldPlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "emerald", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( EmeraldPlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "emerald", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( EmeraldShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "emerald", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( GarnetFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "garnet", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( GarnetPlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "garnet", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( GarnetPlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "garnet", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( GarnetPlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "garnet", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( GarnetPlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "garnet", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( GarnetPlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "garnet", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( GarnetPlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "garnet", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( GarnetShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "garnet", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( IceFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "ice", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( IcePlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "ice", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( IcePlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "ice", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( IcePlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "ice", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( IcePlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "ice", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( IcePlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "ice", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( IcePlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "ice", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( IceShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "ice", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( JadeFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "jade", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( JadePlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "jade", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( JadePlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "jade", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( JadePlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "jade", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( JadePlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "jade", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( JadePlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "jade", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( JadePlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "jade", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( JadeShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "jade", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( MarbleFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "marble", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( MarblePlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "marble", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( MarblePlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "marble", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( MarblePlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "marble", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( MarblePlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "marble", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( MarblePlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "marble", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( MarblePlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "marble", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( MarbleShields ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "marble", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( OnyxFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "onyx", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( OnyxPlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "onyx", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( OnyxPlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "onyx", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( OnyxPlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "onyx", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( OnyxPlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "onyx", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( OnyxPlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "onyx", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( OnyxPlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "onyx", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( OnyxShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "onyx", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( QuartzFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "quartz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( QuartzPlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "quartz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( QuartzPlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "quartz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( QuartzPlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "quartz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( QuartzPlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "quartz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( QuartzPlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "quartz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( QuartzPlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "quartz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( QuartzShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "quartz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( RubyFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( RubyPlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( RubyPlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( RubyPlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( RubyPlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( RubyPlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( RubyPlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( RubyShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SapphireFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "sapphire", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SapphirePlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "sapphire", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SapphirePlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "sapphire", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SapphirePlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "sapphire", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SapphirePlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "sapphire", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SapphirePlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "sapphire", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SapphirePlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "sapphire", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SapphireShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "sapphire", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SilverFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "silver", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SilverPlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "silver", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SilverPlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "silver", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SilverPlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "silver", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SilverPlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "silver", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SilverPlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "silver", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SilverPlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "silver", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SilverShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "silver", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SpinelFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "spinel", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SpinelPlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "spinel", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SpinelPlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "spinel", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SpinelPlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "spinel", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SpinelPlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "spinel", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SpinelPlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "spinel", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SpinelPlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "spinel", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( SpinelShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "spinel", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( StarRubyFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "star ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( StarRubyPlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "star ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( StarRubyPlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "star ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( StarRubyPlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "star ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( StarRubyPlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "star ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( StarRubyPlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "star ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( StarRubyPlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "star ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( StarRubyShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "star ruby", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TopazFemalePlateChest ), 5513, 1, 0x1C04, Server.Misc.MaterialInfo.GetMaterialColor( "topaz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TopazPlateArms ), 5494, 1, 0x1410, Server.Misc.MaterialInfo.GetMaterialColor( "topaz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TopazPlateChest ), 5521, 1, 0x1415, Server.Misc.MaterialInfo.GetMaterialColor( "topaz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TopazPlateGloves ), 5372, 1, 0x1414, Server.Misc.MaterialInfo.GetMaterialColor( "topaz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TopazPlateGorget ), 5352, 1, 0x1413, Server.Misc.MaterialInfo.GetMaterialColor( "topaz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TopazPlateHelm ), 5320, 1, 0x1419, Server.Misc.MaterialInfo.GetMaterialColor( "topaz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TopazPlateLegs ), 5509, 1, 0x1411, Server.Misc.MaterialInfo.GetMaterialColor( "topaz", "", 0 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){Add( new GenericBuyInfo( typeof( TopazShield ), 5415, 1, 0x1B76, Server.Misc.MaterialInfo.GetMaterialColor( "topaz", "", 0 ) ) ); }
			}
		}
...
/////----------------------------------------------------------------------------------------------------------------------------------------------------/////
	...
	{ 
		...
		{ 
			public InternalBuyInfo() 
			{
				...
				Add( new GenericBuyInfo( typeof( IronIngot ), 5, Utility.Random( 30,310 ), 0x1BF2, 0 ) );
				Add( new GenericBuyInfo( typeof( Tongs ), 13, Utility.Random( 3,31 ), 0xFBB, 0 ) ); 
				...
				Add( new GenericBuyInfo( typeof( Pitchfork ), 19, Utility.Random( 3,31 ), 0xE87, 0xB3A ) );
	...
	public class SBHolidayXmas : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( WreathDeed ), 300, Utility.Random( 1,3 ), 0x14EF, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GreenStocking ), 110, Utility.Random( 1,3 ), 0x2bd9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( RedStocking ), 110, Utility.Random( 1,3 ), 0x2bdb, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( SnowPileDeco ), 80, Utility.Random( 1,3 ), 0x8E2, 0x481 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( Snowman ), 230, Utility.Random( 1,3 ), 0x2328, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( BlueSnowflake ), 100, Utility.Random( 1,3 ), 0x232E, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( WhiteSnowflake ), 100, Utility.Random( 1,3 ), 0x232F, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( RedPoinsettia ), 120, Utility.Random( 1,3 ), 0x2330, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( WhitePoinsettia ), 120, Utility.Random( 1,3 ), 0x2331, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( IcyPatch ), 60, Utility.Random( 1,3 ), 0x122F, 0x481 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( IcicleLargeSouth ), 80, Utility.Random( 1,3 ), 0x4572, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( IcicleMedSouth ), 70, Utility.Random( 1,3 ), 0x4573, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( IcicleSmallSouth ), 60, Utility.Random( 1,3 ), 0x4574, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( IcicleLargeEast ), 80, Utility.Random( 1,3 ), 0x4575, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( IcicleMedEast ), 70, Utility.Random( 1,3 ), 0x4576, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( IcicleSmallEast ), 60, Utility.Random( 1,3 ), 0x4577, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GingerBreadHouseDeed ), 450, Utility.Random( 1,3 ), 0x14EF, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CandyCane ), 20, Utility.Random( 1,3 ), 0x2bdd, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GingerBreadCookie ), 20, Utility.Random( 1,3 ), 0x2be1, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HolidayBell ), 280, Utility.Random( 1,3 ), 0x1C12, 0xA ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HolidayBells ), 560, Utility.Random( 1,3 ), 0x5474, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxRectangle ), 140, Utility.Random( 1,3 ), 0x46A6, Utility.RandomList( 0x672, 0x454, 0x507, 0x4ac, 0x504, 0x84b, 0x495, 0x97c, 0x493, 0x4a8, 0x494, 0x4aa, 0xb8b, 0x84f, 0x491, 0x851, 0x503, 0xb8c, 0x4ab, 0x84B ) ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxCube ), 140, Utility.Random( 1,3 ), 0x46A2, Utility.RandomList( 0x672, 0x454, 0x507, 0x4ac, 0x504, 0x84b, 0x495, 0x97c, 0x493, 0x4a8, 0x494, 0x4aa, 0xb8b, 0x84f, 0x491, 0x851, 0x503, 0xb8c, 0x4ab, 0x84B ) ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxCylinder ), 140, Utility.Random( 1,3 ), 0x46A3, Utility.RandomList( 0x672, 0x454, 0x507, 0x4ac, 0x504, 0x84b, 0x495, 0x97c, 0x493, 0x4a8, 0x494, 0x4aa, 0xb8b, 0x84f, 0x491, 0x851, 0x503, 0xb8c, 0x4ab, 0x84B ) ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxOctogon ), 140, Utility.Random( 1,3 ), 0x46A4, Utility.RandomList( 0x672, 0x454, 0x507, 0x4ac, 0x504, 0x84b, 0x495, 0x97c, 0x493, 0x4a8, 0x494, 0x4aa, 0xb8b, 0x84f, 0x491, 0x851, 0x503, 0xb8c, 0x4ab, 0x84B ) ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxAngel ), 140, Utility.Random( 1,3 ), 0x46A7, Utility.RandomList( 0x672, 0x454, 0x507, 0x4ac, 0x504, 0x84b, 0x495, 0x97c, 0x493, 0x4a8, 0x494, 0x4aa, 0xb8b, 0x84f, 0x491, 0x851, 0x503, 0xb8c, 0x4ab, 0x84B ) ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxNeon ), 140, Utility.Random( 1,3 ), 0x232A, Utility.RandomList( 0x438, 0x424, 0x433, 0x445, 0x42b, 0x448 ) ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GiftBox ), 140, Utility.Random( 1,3 ), 0x232A, Utility.RandomDyedHue() ) ); }
				...
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( ChristmasRobe ), 50, Utility.Random( 1,3 ), 0x2684, 1153 ) ); }
			}
		}
	...
	public class SBHolidayDeco : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( WreathDeed ), 300, Utility.Random( 1,3 ), 0x14EF, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GreenStocking ), 110, Utility.Random( 1,3 ), 0x2bd9, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( RedStocking ), 110, Utility.Random( 1,3 ), 0x2bdb, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( SnowPileDeco ), 80, Utility.Random( 1,3 ), 0x8E2, 0x481 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( Snowman ), 230, Utility.Random( 1,3 ), 0x2328, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( BlueSnowflake ), 100, Utility.Random( 1,3 ), 0x232E, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( WhiteSnowflake ), 100, Utility.Random( 1,3 ), 0x232F, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( RedPoinsettia ), 120, Utility.Random( 1,3 ), 0x2330, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( WhitePoinsettia ), 120, Utility.Random( 1,3 ), 0x2331, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( IcyPatch ), 60, Utility.Random( 1,3 ), 0x122F, 0x481 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( IcicleLargeSouth ), 80, Utility.Random( 1,3 ), 0x4572, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( IcicleMedSouth ), 70, Utility.Random( 1,3 ), 0x4573, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( IcicleSmallSouth ), 60, Utility.Random( 1,3 ), 0x4574, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( IcicleLargeEast ), 80, Utility.Random( 1,3 ), 0x4575, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( IcicleMedEast ), 70, Utility.Random( 1,3 ), 0x4576, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( IcicleSmallEast ), 60, Utility.Random( 1,3 ), 0x4577, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GingerBreadHouseDeed ), 450, Utility.Random( 1,3 ), 0x14EF, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CandyCane ), 20, Utility.Random( 1,3 ), 0x2bdd, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GingerBreadCookie ), 20, Utility.Random( 1,3 ), 0x2be1, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HolidayBell ), 280, Utility.Random( 1,3 ), 0x1C12, 0xA ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HolidayBells ), 560, Utility.Random( 1,3 ), 0x5474, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxRectangle ), 140, Utility.Random( 1,3 ), 0x46A6, Utility.RandomList( 0x672, 0x454, 0x507, 0x4ac, 0x504, 0x84b, 0x495, 0x97c, 0x493, 0x4a8, 0x494, 0x4aa, 0xb8b, 0x84f, 0x491, 0x851, 0x503, 0xb8c, 0x4ab, 0x84B ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxCube ), 140, Utility.Random( 1,3 ), 0x46A2, Utility.RandomList( 0x672, 0x454, 0x507, 0x4ac, 0x504, 0x84b, 0x495, 0x97c, 0x493, 0x4a8, 0x494, 0x4aa, 0xb8b, 0x84f, 0x491, 0x851, 0x503, 0xb8c, 0x4ab, 0x84B ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxCylinder ), 140, Utility.Random( 1,3 ), 0x46A3, Utility.RandomList( 0x672, 0x454, 0x507, 0x4ac, 0x504, 0x84b, 0x495, 0x97c, 0x493, 0x4a8, 0x494, 0x4aa, 0xb8b, 0x84f, 0x491, 0x851, 0x503, 0xb8c, 0x4ab, 0x84B ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxOctogon ), 140, Utility.Random( 1,3 ), 0x46A4, Utility.RandomList( 0x672, 0x454, 0x507, 0x4ac, 0x504, 0x84b, 0x495, 0x97c, 0x493, 0x4a8, 0x494, 0x4aa, 0xb8b, 0x84f, 0x491, 0x851, 0x503, 0xb8c, 0x4ab, 0x84B ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxAngel ), 140, Utility.Random( 1,3 ), 0x46A7, Utility.RandomList( 0x672, 0x454, 0x507, 0x4ac, 0x504, 0x84b, 0x495, 0x97c, 0x493, 0x4a8, 0x494, 0x4aa, 0xb8b, 0x84f, 0x491, 0x851, 0x503, 0xb8c, 0x4ab, 0x84B ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GiftBoxNeon ), 140, Utility.Random( 1,3 ), 0x232A, Utility.RandomList( 0x438, 0x424, 0x433, 0x445, 0x42b, 0x448 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GiftBox ), 140, Utility.Random( 1,3 ), 0x232A, Utility.RandomDyedHue() ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HolidayTreeDeed ), 860, Utility.Random( 1,3 ), 0x0CC8, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HolidayTreeFlatDeed ), 860, Utility.Random( 1,3 ), 0x0CC8, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( NewHolidayTree ), 980, Utility.Random( 1,3 ), 0x4C7D, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( RibbonTreeSmall ), 700, Utility.Random( 1,3 ), 0x5462, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( RibbonTree ), 800, Utility.Random( 1,3 ), 0x5461, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( ChristmasRobe ), 50, Utility.Random( 1,3 ), 0x2684, 1153 ) ); }
			}
		}
	...
	public class SBHolidayHalloween : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( BloodyTableAddonDeed ), 1500, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( BloodPentagramDeed ), 3800, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				...
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree6 ), 800, Utility.Random( 1,3 ), 0xCCD, 0x2C1 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree5 ), 800, Utility.Random( 1,3 ), 0x224D, 0x2C1 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree4 ), 800, Utility.Random( 1,3 ), 0xCD3, 0x2C1 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree3 ), 800, Utility.Random( 1,3 ), 0x224A, 0x2C5 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree2 ), 800, Utility.Random( 1,3 ), 0xD94, 0x2C5 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree1 ), 800, Utility.Random( 1,3 ), 0xCE3, 0x2C5 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTortSkel ), 450, Utility.Random( 1,3 ), 0x1A03, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenStoneSpike2 ), 600, Utility.Random( 1,3 ), 0x2202, 0x322 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenStoneSpike ), 600, Utility.Random( 1,3 ), 0x2201, 0x322 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenStoneColumn ), 500, Utility.Random( 1,3 ), 0x77, 0x322 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenSkullPole ), 540, Utility.Random( 1,3 ), 0x2204, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenShrineChaosDeed ), 1380, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenPylonFire ), 2100, Utility.Random( 1,3 ), 0x19AF, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenPylon ), 1800, Utility.Random( 1,3 ), 0x1ECB, 0x322 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenMaiden ), 2780, Utility.Random( 1,3 ), 0x124B, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenGrave3 ), 350, Utility.Random( 1,3 ), 0xEDE, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenGrave2 ), 350, Utility.Random( 1,3 ), 0x116E, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenGrave1 ), 350, Utility.Random( 1,3 ), 0x1168, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenColumn ), 1100, Utility.Random( 1,3 ), 0x196, 0x322 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenChopper ), 1760, Utility.Random( 1,3 ), 0x1245, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenBonePileDeed ), 680, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenBlood ), 90, Utility.Random( 1,3 ), 0x122A, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( AppleBobbingBarrel ), 170, Utility.Random( 1,3 ), 0x0F33, 0 ) ); }
				Add( new GenericBuyInfo( typeof( CarvedPumpkin ), Utility.Random( 80,200 ), Utility.Random( 1,3 ), 0x4694, 0 ) );
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin2 ), Utility.Random( 80,200 ), Utility.Random( 1,3 ), 0x4698, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin3 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x5499, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin4 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x549D, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin5 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54A1, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin6 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54A5, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin7 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54A9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin8 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54AD, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin9 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54B1, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin10 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54B5, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin11 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54B9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin12 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54BD, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin13 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54C1, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin14 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54C9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin15 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54CC, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin16 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54CE, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin17 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54D2, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin18 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54D6, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin19 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54DA, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin20 ), Utility.Random( 1500,5000 ), Utility.Random( 1,3 ), 0x5481, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( DeadBodyEWDeed ), 345, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( DeadBodyNSDeed ), 345, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( EvilFireplaceSouthFaceAddonDeed ), 6800, Utility.Random( 1,3 ), 0x14EF, 1175 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( EvilFireplaceEastFaceAddonDeed ), 6800, Utility.Random( 1,3 ), 0x14EF, 1175 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( halloween_coffin_eastAddonDeed ), 470, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( halloween_coffin_southAddonDeed ), 470, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( halloween_block_southAddonDeed ), 430, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( halloween_block_eastAddonDeed ), 430, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				...
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( PumpkinScarecrow ), 240, Utility.Random( 1,3 ), 0x469B, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GrimWarning ), 120, Utility.Random( 1,3 ), 0x42BD, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( SkullsOnPike ), 120, Utility.Random( 1,3 ), 0x42B5, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( BlackCatStatue ), 100, Utility.Random( 1,3 ), 0x4688, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( RuinedTapestry ), 135, Utility.Random( 1,3 ), 0x4699, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( HalloweenWeb ), 185, Utility.Random( 1,3 ), 0xEE3, Utility.RandomList( 43, 1175, 1151 ) ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( halloween_shackles ), 125, Utility.Random( 1,3 ), 5696, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( halloween_ruined_bookcase ), 340, Utility.Random( 1,3 ), 0x0C14, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( halloween_covered_chair ), 220, Utility.Random( 1,3 ), 3095, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( halloween_HauntedMirror1 ), 270, Utility.Random( 1,3 ), 10875, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( halloween_HauntedMirror2 ), 270, Utility.Random( 1,3 ), 10876, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( halloween_devil_face ), 150, Utility.Random( 1,3 ), 4348, 0 ) ); }
				if ( MyServerSettings.SellCommonChance() ){ Add( new GenericBuyInfo( typeof( PackedCostume ), 230, Utility.Random( 1,3 ), 0x46A3, 0x5E0 ) ); }
				if ( MyServerSettings.SellCommonChance() ){ Add( new GenericBuyInfo( typeof( WrappedCandy ), 20, Utility.Random( 1,3 ), 0x469E, 0 ) ); }
				if ( MyServerSettings.SellCommonChance() ){ Add( new GenericBuyInfo( typeof( HalloweenPack ), 130, Utility.Random( 1,3 ), 0x46A3, 0x5E0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( NecromancerTable ), 520, Utility.Random( 1,3 ), 0x149D, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( NecromancerBanner ), 350, Utility.Random( 1,3 ), 0x149B, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( BurningScarecrowA ), 290, Utility.Random( 1,3 ), 0x23A9, 0 ) ); }
				if ( MyServerSettings.SellChance() ){ Add( new GenericBuyInfo( typeof( GothicCandelabraA ), 280, Utility.Random( 1,3 ), 0x052D, 0 ) ); }
			}
		}
	...
	public class SBScaryDeco : SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( BloodyTableAddonDeed ), 1500, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( BloodPentagramDeed ), 3800, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( MongbatDartBoardEastDeed ), 1200, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( MongbatDartBoardSouthDeed ), 1200, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree6 ), 800, Utility.Random( 1,3 ), 0xCCD, 0x2C1 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree5 ), 800, Utility.Random( 1,3 ), 0x224D, 0x2C1 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree4 ), 800, Utility.Random( 1,3 ), 0xCD3, 0x2C1 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree3 ), 800, Utility.Random( 1,3 ), 0x224A, 0x2C5 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree2 ), 800, Utility.Random( 1,3 ), 0xD94, 0x2C5 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTree1 ), 800, Utility.Random( 1,3 ), 0xCE3, 0x2C5 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenTortSkel ), 450, Utility.Random( 1,3 ), 0x1A03, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenStoneSpike2 ), 600, Utility.Random( 1,3 ), 0x2202, 0x322 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenStoneSpike ), 600, Utility.Random( 1,3 ), 0x2201, 0x322 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenStoneColumn ), 500, Utility.Random( 1,3 ), 0x77, 0x322 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenSkullPole ), 540, Utility.Random( 1,3 ), 0x2204, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenShrineChaosDeed ), 1380, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenPylonFire ), 2100, Utility.Random( 1,3 ), 0x19AF, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenPylon ), 1800, Utility.Random( 1,3 ), 0x1ECB, 0x322 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenMaiden ), 2780, Utility.Random( 1,3 ), 0x124B, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenGrave3 ), 350, Utility.Random( 1,3 ), 0xEDE, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenGrave2 ), 350, Utility.Random( 1,3 ), 0x116E, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenGrave1 ), 350, Utility.Random( 1,3 ), 0x1168, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenColumn ), 1100, Utility.Random( 1,3 ), 0x196, 0x322 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenChopper ), 1760, Utility.Random( 1,3 ), 0x1245, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenBonePileDeed ), 680, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenBlood ), 90, Utility.Random( 1,3 ), 0x122A, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( AppleBobbingBarrel ), 170, Utility.Random( 1,3 ), 0x0F33, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin ), Utility.Random( 80,200 ), Utility.Random( 1,3 ), 0x4694, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin2 ), Utility.Random( 80,200 ), Utility.Random( 1,3 ), 0x4698, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin3 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x5499, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin4 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x549D, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin5 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54A1, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin6 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54A5, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin7 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54A9, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin8 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54AD, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin9 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54B1, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin10 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54B5, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin11 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54B9, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin12 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54BD, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin13 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54C1, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin14 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54C9, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin15 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54CC, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin16 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54CE, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin17 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54D2, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin18 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54D6, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin19 ), Utility.Random( 150,500 ), Utility.Random( 1,3 ), 0x54DA, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( CarvedPumpkin20 ), Utility.Random( 1500,5000 ), Utility.Random( 1,3 ), 0x5481, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( DeadBodyEWDeed ), 345, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( DeadBodyNSDeed ), 345, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( EvilFireplaceSouthFaceAddonDeed ), 6800, Utility.Random( 1,3 ), 0x14EF, 1175 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( EvilFireplaceEastFaceAddonDeed ), 6800, Utility.Random( 1,3 ), 0x14EF, 1175 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( halloween_coffin_eastAddonDeed ), 470, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( halloween_coffin_southAddonDeed ), 470, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( halloween_block_southAddonDeed ), 430, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( halloween_block_eastAddonDeed ), 430, Utility.Random( 1,3 ), 0x14EF, 0x96C ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( LargeDyingPlant ), 225, Utility.Random( 1,3 ), 0x42B9, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( DyingPlant ), 175, Utility.Random( 1,3 ), 0x42BA, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( PumpkinScarecrow ), 240, Utility.Random( 1,3 ), 0x469B, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GrimWarning ), 120, Utility.Random( 1,3 ), 0x42BD, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( SkullsOnPike ), 120, Utility.Random( 1,3 ), 0x42B5, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( BlackCatStatue ), 100, Utility.Random( 1,3 ), 0x4688, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( RuinedTapestry ), 135, Utility.Random( 1,3 ), 0x4699, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenWeb ), 185, Utility.Random( 1,3 ), 0xEE3, Utility.RandomList( 43, 1175, 1151 ) ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( halloween_shackles ), 125, Utility.Random( 1,3 ), 5696, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( halloween_ruined_bookcase ), 340, Utility.Random( 1,3 ), 0x0C14, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( halloween_covered_chair ), 220, Utility.Random( 1,3 ), 3095, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( halloween_HauntedMirror1 ), 270, Utility.Random( 1,3 ), 10875, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( halloween_HauntedMirror2 ), 270, Utility.Random( 1,3 ), 10876, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( halloween_devil_face ), 150, Utility.Random( 1,3 ), 4348, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( PackedCostume ), 230, Utility.Random( 1,3 ), 0x46A3, 0x5E0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( WrappedCandy ), 20, Utility.Random( 1,3 ), 0x469E, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( HalloweenPack ), 130, Utility.Random( 1,3 ), 0x46A3, 0x5E0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( NecromancerTable ), 520, Utility.Random( 1,3 ), 0x149D, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( NecromancerBanner ), 350, Utility.Random( 1,3 ), 0x149B, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( BurningScarecrowA ), 290, Utility.Random( 1,3 ), 0x23A9, 0 ) ); }
				if ( MyServerSettings.SellVeryRareChance() ){ Add( new GenericBuyInfo( typeof( GothicCandelabraA ), 280, Utility.Random( 1,3 ), 0x052D, 0 ) ); }
			}
		}
	...
	public class SBLibraryGuild: SBInfo
	{
		...
		public class InternalBuyInfo : List<GenericBuyInfo>
		{
			public InternalBuyInfo()
			{
				...
				Add( new GenericBuyInfo( typeof( LearnLeatherBook ), 5, Utility.Random( 1,15 ), 0x4C60, 0 ) );
				Add( new GenericBuyInfo( typeof( LearnMiscBook ), 5, Utility.Random( 1,15 ), 0x4C5D, 0 ) );
				Add( new GenericBuyInfo( typeof( LearnMetalBook ), 5, Utility.Random( 1,15 ), 0x4C5B, 0 ) );
				Add( new GenericBuyInfo( typeof( LearnWoodBook ), 5, Utility.Random( 1,15 ), 0x4C5E, 0 ) );
				Add( new GenericBuyInfo( typeof( LearnReagentsBook ), 5, Utility.Random( 1,15 ), 0x4C5E, 0 ) );
				Add( new GenericBuyInfo( typeof( LearnTailorBook ), 5, Utility.Random( 1,15 ), 0x4C5E, 0 ) );
				Add( new GenericBuyInfo( typeof( LearnGraniteBook ), 5, Utility.Random( 1,15 ), 0x4C5C, 0 ) );
				Add( new GenericBuyInfo( typeof( LearnScalesBook ), 5, Utility.Random( 1,15 ), 0x4C60, 0 ) );
