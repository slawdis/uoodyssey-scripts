	  ...
	  /* End Captcha Mod *///////////////////////////////////////////
		...
		*/
		...
		public virtual void UpdateFollowers(){
			...
			if ( (this.Skills[SkillName.Herding].Base >= 120.0) && (this.Skills[SkillName.Veterinary].Base >= 120.0) && (this.Skills[SkillName.AnimalLore].Base >= 120.0) && (this.Skills[SkillName.AnimalTaming].Base >= 120.0) )
			this.FollowersMax = 8;

			else if ( (this.Skills[SkillName.Herding].Base >= 90) && (this.Skills[SkillName.Veterinary].Base >= 90) && (this.Skills[SkillName.AnimalLore].Base >= 90) && (this.Skills[SkillName.AnimalTaming].Base >= 90) )
			this.FollowersMax = 7;

			else if ( (this.Skills[SkillName.Herding].Base >= 60) && (this.Skills[SkillName.Veterinary].Base >= 60) && (this.Skills[SkillName.AnimalLore].Base >= 60) && (this.Skills[SkillName.AnimalTaming].Base >= 60) )
			this.FollowersMax = 6;
		...
		public static void SkillVerification( Mobile m )
		{
			if ( m is PlayerMobile )
			{
				...
				if ( m.Skills.Cap == 13000 || m.Skills.Cap == 18000 )
				{
					...
					else if ( Server.Items.CharacterDatabase.GetKeys( m, "Virtue" ) ){ adjust = false; }
				}
