		...
		*/
		...
		public virtual void OnThink()
		{
			...
			if ( this is HenchmanMonster || this is HenchmanFighter || this is HenchmanWizard || this is HenchmanArcher || MyServerSettings.FastFriends( this ) )
			{
				...
				if ( leader != null )
				{
					if ( Server.Misc.MyServerSettings.NoMountsInCertainRegions() && Server.Mobiles.AnimalTrainer.IsNoMountRegion( leader, Region.Find( leader.Location, leader.Map ) ) && Server.Mobiles.AnimalTrainer.AllowMagicSpeed( leader, Region.Find( leader.Location, leader.Map ) ) )
					{
