...
//				list.Add( 1060660, "team\t{0}", m_Team );
		...
		public static void SpreadOut( Mobile m )
		{
			if ( m is BaseVendor || m is Adventurers || m is Jedi )
			{
				...
				if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Lodor ){ m.Location = Worlds.GetRandomLocation( "the Land of Lodoria", "land" ); m.WhisperHue = 911; }
				else if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Sosaria ){ m.Location = Worlds.GetRandomLocation( "the Land of Sosaria", "land" ); m.WhisperHue = 911; }
				else if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.SerpentIsland ){ m.Location = Worlds.GetRandomLocation( "the Serpent Island", "land" ); m.WhisperHue = 911; }
				else if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.IslesDread ){ m.Location = Worlds.GetRandomLocation( "the Isles of Dread", "land" ); m.WhisperHue = 911; }
				else if ( m.X >= 1125 && m.Y >= 298 && m.X <= 1131 && m.Y <= 305 && m.Map == Map.SavagedEmpire ){ m.Location = Worlds.GetRandomLocation( "the Savaged Empire", "land" ); m.WhisperHue = 911; }
				else if ( m.X >= 5457 && m.Y >= 3300 && m.X <= 5459 && m.Y <= 3302 && m.Map == Map.Sosaria ){ m.Location = Worlds.GetRandomLocation( "the Land of Ambrosia", "land" ); m.WhisperHue = 911; }
				else if ( m.X >= 608 && m.Y >= 4090 && m.X <= 704 && m.Y <= 4096 && m.Map == Map.Sosaria ){ m.Location = Worlds.GetRandomLocation( "the Island of Umber Veil", "land" ); m.WhisperHue = 911; }
				else if ( m.X >= 6126 && m.Y >= 827 && m.X <= 6132 && m.Y <= 833 && m.Map == Map.Sosaria ){ m.Location = Worlds.GetRandomLocation( "the Bottle World of Kuldar", "land" ); m.WhisperHue = 911; }
				else if ( m.X == 4 && m.Y == 4 && m.Map == Map.Underworld ){ m.Location = Worlds.GetRandomLocation( "the Underworld", "land" ); m.WhisperHue = 911; }
			}
			else
			{
				///////////////// SPREAD SEA SPAWNS OVER THE OCEANS AROUND THE LAND /////////////////
				if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Lodor ){ m.Location = Worlds.GetRandomLocation( "the Land of Lodoria", "sea" ); m.WhisperHue = 999; }
				else if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.Sosaria ){ m.Location = Worlds.GetRandomLocation( "the Land of Sosaria", "sea" ); m.WhisperHue = 999; }
				else if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.SerpentIsland ){ m.Location = Worlds.GetRandomLocation( "the Serpent Island", "sea" ); m.WhisperHue = 999; }
				else if ( m.X >= 0 && m.Y >= 0 && m.X <= 6 && m.Y <= 6 && m.Map == Map.IslesDread ){ m.Location = Worlds.GetRandomLocation( "the Isles of Dread", "sea" ); m.WhisperHue = 999; }
				else if ( m.X >= 1125 && m.Y >= 298 && m.X <= 1131 && m.Y <= 305 && m.Map == Map.SavagedEmpire ){ m.Location = Worlds.GetRandomLocation( "the Savaged Empire", "sea" ); m.WhisperHue = 999; }
				else if ( m.X >= 5457 && m.Y >= 3300 && m.X <= 5459 && m.Y <= 3302 && m.Map == Map.Sosaria ){ m.Location = Worlds.GetRandomLocation( "the Land of Ambrosia", "sea" ); m.WhisperHue = 999; }
				else if ( m.X >= 608 && m.Y >= 4090 && m.X <= 704 && m.Y <= 4096 && m.Map == Map.Sosaria ){ m.Location = Worlds.GetRandomLocation( "the Island of Umber Veil", "sea" ); m.WhisperHue = 999; }
				else if ( m.X >= 6126 && m.Y >= 827 && m.X <= 6132 && m.Y <= 833 && m.Map == Map.Sosaria ){ m.Location = Worlds.GetRandomLocation( "the Bottle World of Kuldar", "sea" ); m.WhisperHue = 999; }
				else if ( m.X == 3 && m.Y == 3 && m.Map == Map.Underworld ){ m.Location = Worlds.GetRandomLocation( "the Underworld", "sea" ); m.WhisperHue = 999; }
				else if ( m.X == 4 && m.Y == 4 && m.Map == Map.Underworld ){ m.Location = Worlds.GetRandomLocation( "the Underworld", "land" ); m.WhisperHue = 911; }

				if ( m.WhisperHue == 999 && ( m is Balron || m is Daemon || m is RidingDragon || m is Dragons || m is Wyrms ) ){ m.CanSwim = true; }
			}
		}
		...
		public static void SpreadItems( Item i )
		{
			if ( i is LandChest || i is StrangePortal )
			{
				...
				if ( i.X >= 0 && i.Y >= 0 && i.X <= 6 && i.Y <= 6 && i.Map == Map.Lodor ){ i.Location = Worlds.GetRandomLocation( "the Land of Lodoria", "land" ); }
				else if ( i.X >= 0 && i.Y >= 0 && i.X <= 6 && i.Y <= 6 && i.Map == Map.Sosaria ){ i.Location = Worlds.GetRandomLocation( "the Land of Sosaria", "land" ); }
				else if ( i.X >= 0 && i.Y >= 0 && i.X <= 6 && i.Y <= 6 && i.Map == Map.SerpentIsland ){ i.Location = Worlds.GetRandomLocation( "the Serpent Island", "land" ); }
				else if ( i.X >= 0 && i.Y >= 0 && i.X <= 6 && i.Y <= 6 && i.Map == Map.IslesDread ){ i.Location = Worlds.GetRandomLocation( "the Isles of Dread", "land" ); }
				else if ( i.X >= 1125 && i.Y >= 298 && i.X <= 1131 && i.Y <= 305 && i.Map == Map.SavagedEmpire ){ i.Location = Worlds.GetRandomLocation( "the Savaged Empire", "land" ); }
				else if ( i.X >= 5457 && i.Y >= 3300 && i.X <= 5459 && i.Y <= 3302 && i.Map == Map.Sosaria ){ i.Location = Worlds.GetRandomLocation( "the Land of Ambrosia", "land" ); }
				else if ( i.X >= 608 && i.Y >= 4090 && i.X <= 704 && i.Y <= 4096 && i.Map == Map.Sosaria ){ i.Location = Worlds.GetRandomLocation( "the Island of Umber Veil", "land" ); }
				else if ( i.X == 4 && i.Y == 4 && i.Map == Map.Underworld ){ i.Location = Worlds.GetRandomLocation( "the Underworld", "land" ); }
			}
			else if ( i is WaterChest )
			{
				///////////////// SPREAD BOATS OVER THE OCEANS /////////////////
				if ( i.X >= 0 && i.Y >= 0 && i.X <= 6 && i.Y <= 6 && i.Map == Map.Lodor ){ i.Location = Worlds.GetRandomLocation( "the Land of Lodoria", "sea" ); }
				else if ( i.X >= 0 && i.Y >= 0 && i.X <= 6 && i.Y <= 6 && i.Map == Map.Sosaria ){ i.Location = Worlds.GetRandomLocation( "the Land of Sosaria", "sea" ); }
				else if ( i.X >= 0 && i.Y >= 0 && i.X <= 6 && i.Y <= 6 && i.Map == Map.SerpentIsland ){ i.Location = Worlds.GetRandomLocation( "the Serpent Island", "sea" ); }
				else if ( i.X >= 0 && i.Y >= 0 && i.X <= 6 && i.Y <= 6 && i.Map == Map.IslesDread ){ i.Location = Worlds.GetRandomLocation( "the Isles of Dread", "sea" ); }
				else if ( i.X >= 1125 && i.Y >= 298 && i.X <= 1131 && i.Y <= 305 && i.Map == Map.SavagedEmpire ){ i.Location = Worlds.GetRandomLocation( "the Savaged Empire", "sea" ); }
				else if ( i.X >= 5457 && i.Y >= 3300 && i.X <= 5459 && i.Y <= 3302 && i.Map == Map.Sosaria ){ i.Location = Worlds.GetRandomLocation( "the Land of Ambrosia", "sea" ); }
				else if ( i.X >= 608 && i.Y >= 4090 && i.X <= 704 && i.Y <= 4096 && i.Map == Map.Sosaria ){ i.Location = Worlds.GetRandomLocation( "the Island of Umber Veil", "sea" ); }
				else if ( i.X >= 6126 && i.Y >= 827 && i.X <= 6132 && i.Y <= 833 && i.Map == Map.Sosaria ){ i.Location = Worlds.GetRandomLocation( "the Bottle World of Kuldar", "sea" ); }
				else if ( i.X == 3 && i.Y == 3 && i.Map == Map.Underworld ){ i.Location = Worlds.GetRandomLocation( "the Underworld", "sea" ); }
			}
		}
		...
		public void Spawn( int index )
		{
			...
			if ( ent is Mobile )
			{
				...
				if ( !MyServerSettings.AllowElephants() && m is Mastadon ){ m.Delete(); m = new GrizzlyBearRiding(); }
				else if ( !MyServerSettings.AllowElephants() && m is Mammoth ){ m.Delete(); m = new PolarBear(); }
				else if ( !MyServerSettings.AllowElephants() && m is Elephant ){ m.Delete(); m = new GrizzlyBearRiding(); }
				else if ( !MyServerSettings.AllowElephants() && ( m is Zebra || m is ZebraRiding ) ){ m.Delete(); m = new Horse(); }
...
[spawngen save <region>
	...
	Complete list of regions are in Data/XML/Regions.xml.
