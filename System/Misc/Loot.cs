...
namespace Server
{
	public class Loot
	{
		...
		private static Type[] m_ArtyTypes = new Type[]
			{
				...
				typeof( JesterHatofChuckles ), 		typeof( ShaMontorrossbow ), 					typeof( EarringsOfProtection ),
				...
				typeof( ColoringBook ),				typeof( BagOfHolding )
			};
		...
		public static Item RandomArmorOrHat( bool inIslesDread )
		{
			if ( inIslesDread )
		...
		public static Item RandomArmorOrShieldOrWeaponOrJewelry( bool inIslesDread )
		{
			if ( inIslesDread )
