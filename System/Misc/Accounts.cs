		...
		private static CityInfo[] StartingCities = new CityInfo[]
			{
				...
				new CityInfo( "Montor",		"The Barnacle",		1075073, 2476,	413,	15 ),
				new CityInfo( "Britain",	"The Wayfarer's Inn",	1075074, 1602,	1591,	20 ),
				new CityInfo( "Elidor",	"The Scholars Inn",	1075075, 4408,	1168,	0  ),
				new CityInfo( "Moon",	"The Traveler's Inn",	1075076, 1845,	2745,	0  ),
				new CityInfo( "DevilGuard",		"The Mercenary Inn",	1075078, 1374,	3826,	0  ),
				new CityInfo( "Skara Brae",	"The Falconer's Inn",	1075079, 618,	2234,	0  ),
				new CityInfo( "Luna",		"The Ironwood Inn",	1075080, 2771,	976,	0  )
			};
