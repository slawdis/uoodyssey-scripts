...
namespace Server.Engines.VeteranRewards
{
	public class RewardChoiceGump : Gump
	{
		...
		private void RenderCategories()
		{
			...
			AddHtml( 60, 35, 500, 70, "<B>Odyssey Rewards Program</B><BR>" +
									"Thank you for being a part of the Odyssey community for a full " + intervalAsString + ".  " +
