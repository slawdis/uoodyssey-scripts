...
namespace Server.Gumps
{
	public class HeritageTokenGump : Gump
	{
		...
		public HeritageTokenGump( HeritageToken token ) : base( 60, 36 )
		{
			...
			AddTooltip( 1062914 );
			AddHtmlLocalized( 348, 44, 250, 60, 1062913, 0x7FFF, false, false ); // Rose of Moon
		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			switch ( info.ButtonID )
			{
				...
				case 0x65: types.Add( typeof( RoseOfMoon ) ); cliloc = 1062913; break;
				case 0x66: types.Add( typeof( ShaMontorrossbow ) ); cliloc = 1062915; break;
