		...
		public override void OnResponse( NetState sender, RelayInfo info )
		{
			...
			else if ( button >= 2 )
			{
				...
				if ( button % 2 == 0 )
				{
					...
					from.SendMessage( "Treasures of IslesDread " + selectedToT + " Drops have been enabled" );
				}
				else
				{
					selectedToT = (button - 1) / 2;
					TreasuresOfTokuno.RewardEra = (TreasuresOfTokunoEra)( selectedToT );
					from.SendMessage( "Treasures of IslesDread " + selectedToT + " Rewards have been enabled" );
				}
			}
		}
