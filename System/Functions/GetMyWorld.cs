...
namespace Server.Misc
{
    class Worlds
    {
		...
		public static Map GetMyDefaultMap( string world )
		{
			...
			if ( world == "the Town of Skara Brae" ){ map = Map.Sosaria; }
        ...
        public static string GetAreaEntrance( string zone, Map map )
        {
			...
			else if ( zone == "Pirate Cave" && map == Map.Sosaria ){ loc = new Point3D(1842, 2211, 0); }
			...
			else if ( zone == "the Sanctum of Saltmarsh" && map == Map.Lodor ){ loc = new Point3D(601, 819, 20); map = Map.IslesDread; }
        ...
        public static string GetDungeonListing()
        {
			...
			while ( i < 85 )
			{
				...
				else if ( i == 5 ){ dungeon = "Pirate Cave"; location = GetAreaEntrance( dungeon, Map.Sosaria ); listing = listing + "Sosaria<br>" + dungeon + "<br>" + location + "<br><br>"; }
		...
		public static bool InBuilding( Mobile m )
		{
			...
			else if ( m.Map == Map.Lodor )
			{
				...
				else if ( m.X >= 2069 && m.Y >= 2189 && m.X <= 2084 && m.Y <= 2197 ){ indoors = true; }
