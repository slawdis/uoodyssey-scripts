...
namespace Server.Misc
{
    class MorphingTime
    {
		...
		{
			if ( m.FindItemOnLayer( Layer.OuterTorso ) != null ) { if ( !( m.FindItemOnLayer( Layer.OuterTorso ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.OuterTorso ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.MiddleTorso ) != null ) { if ( !( m.FindItemOnLayer( Layer.MiddleTorso ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.MiddleTorso ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Bracelet ) != null ) { if ( !( m.FindItemOnLayer( Layer.Bracelet ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Bracelet ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Ring ) != null ) { if ( !( m.FindItemOnLayer( Layer.Ring ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Ring ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Helm ) != null ) { if ( !( m.FindItemOnLayer( Layer.Helm ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Helm ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Arms ) != null ) { if ( !( m.FindItemOnLayer( Layer.Arms ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Arms ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.OuterLegs ) != null ) { if ( !( m.FindItemOnLayer( Layer.OuterLegs ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.OuterLegs ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Neck ) != null ) { if ( !( m.FindItemOnLayer( Layer.Neck ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Neck ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Gloves ) != null ) { if ( !( m.FindItemOnLayer( Layer.Gloves ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Gloves ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Talisman ) != null ) { if ( !( m.FindItemOnLayer( Layer.Talisman ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Talisman ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Shoes ) != null ) { if ( !( m.FindItemOnLayer( Layer.Shoes ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Shoes ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Cloak ) != null ) { if ( !( m.FindItemOnLayer( Layer.Cloak ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Cloak ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Waist ) != null ) { if ( !( m.FindItemOnLayer( Layer.Waist ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Waist ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.InnerLegs ) != null ) { if ( !( m.FindItemOnLayer( Layer.InnerLegs ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.InnerLegs ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.InnerTorso ) != null ) { if ( !( m.FindItemOnLayer( Layer.InnerTorso ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.InnerTorso ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Pants ) != null ) { if ( !( m.FindItemOnLayer( Layer.Pants ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Pants ).Hue = Utility.RandomColor(0); } }
			if ( m.FindItemOnLayer( Layer.Shirt ) != null ) { if ( !( m.FindItemOnLayer( Layer.Shirt ) is WornHumanDeco ) ){ m.FindItemOnLayer( Layer.Shirt ).Hue = Utility.RandomColor(0); } }
		}
