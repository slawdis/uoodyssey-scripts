...
namespace Server.Engines.Help
{
	...
	public class HelpGump : Gump
	{
		...
		public HelpGump( Mobile from, int page ) : base( 25, 25 )
		{
			...
			AddButton(100, MainSet, 4005, 4005, 12, GumpButtonType.Reply, 0);
				...
				if ( page == 12 )
				{
					...
					AddButton(310, adjx+adjs, setB, setB, 51, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 99, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Ability Names</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					if ( DB.CharacterSheath == 1 ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, adjx+adjs, setB, setB, 52, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 100, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Auto Sheath</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					if ( DB.ClassicPoisoning == 1 ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, adjx+adjs, setB, setB, 64, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 86, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Classic Poisoning</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
					...
					{
						AddButton(310, adjx+adjs, 4005, 4005, 80, GumpButtonType.Reply, 0);
						AddButton(350, adjx+adjs, 4011, 4011, 97, GumpButtonType.Reply, 0);
						AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Custom Title</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
					...
					{
						if ( DB.Hue != 3 ){ DB.Hue = 0; }
						if ( DB.Hue == 3 ){ setB = 4018; } else { setB = 3609; }
						AddButton(310, adjx+adjs, setB, setB, 81, GumpButtonType.Reply, 0);
						AddButton(350, adjx+adjs, 4011, 4011, 98, GumpButtonType.Reply, 0);
						AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Large Containers</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
					...
					{
						if ( DB.Hue != 2 ){ DB.Hue = 0; }
						if ( DB.Hue == 2 ){ setB = 4018; } else { setB = 3609; }
						AddButton(310, adjx+adjs, setB, setB, 81, GumpButtonType.Reply, 0);
						AddButton(350, adjx+adjs, 4011, 4011, 98, GumpButtonType.Reply, 0);
						AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Container Fix</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

						adjs = adjs + adjm;
						adjx = adjx + adjc;
					}

					AddButton(310, adjx+adjs, 4005, 4005, 55, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 85, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Loot Options</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					AddButton(310, adjx+adjs, 4005, 4005, 65, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 83, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Music Playlist</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					if ( DB.CharMusical == "Forest" ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, adjx+adjs, setB, setB, 53, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 82, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Music Tone</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					if ( ((PlayerMobile)from).PublicMyRunUO == false ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, adjx+adjs, setB, setB, 54, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 84, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Private</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					AddButton(310, adjx+adjs, 4005, 4005, 56, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 87, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Skill Title</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
					...
					AddButton(310, adjx+adjs, setB, setB, 982, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 199, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>" + skillLocks + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
					...
					AddButton(310, adjx+adjs, 4005, 4005, 63, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 88, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Reagent Bar - Alchemy</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					AddButton(310, adjx+adjs, 4005, 4005, 60, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 89, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Reagent Bar - Magery</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					AddButton(310, adjx+adjs, 4005, 4005, 61, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 90, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Reagent Bar - Necromancy</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					AddButton(310, adjx+adjs, 4005, 4005, 62, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 91, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Reagent Bar - Close All</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
					...
					AddButton(310, adjx+adjs, setB, setB, 57, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 92, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Play Style - Normal</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					if ( DB.CharacterEvil == 1 ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, adjx+adjs, setB, setB, 58, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 93, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Play Style - Evil</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					if ( DB.CharacterOriental == 1 ){ setB = 4018; } else { setB = 3609; }
					AddButton(310, adjx+adjs, setB, setB, 59, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 94, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Play Style - Oriental</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
					...
					AddButton(310, adjx+adjs, setB, setB, 984, GumpButtonType.Reply, 0);
					AddButton(350, adjx+adjs, 4011, 4011, 198, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 300, 21, @"<BODY><BASEFONT Color=#FFA200><BIG>Play Style - Barbaric" + amazon + "</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
					...
					AddButton(350, adjx+adjs, 4011, 4011, 96, GumpButtonType.Reply, 0);
					AddHtml( 390, adjx+adjs, 160, 20, @"<BODY><BASEFONT Color=#FFA200><BIG>Magery Spell Color</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x47E ){ setB = 4018; } else { setB = 3609; }
					AddButton(570, adjx+adjs, setB, setB, 500, GumpButtonType.Reply, 0);
					AddHtml( 610, adjx+adjs, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>White</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x94E ){ setB = 4018; } else { setB = 3609; }
					AddButton(700, adjx+adjs, setB, setB, 501, GumpButtonType.Reply, 0);
					AddHtml( 740, adjx+adjs, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Black</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x48D ){ setB = 4018; } else { setB = 3609; }
					AddButton(830, adjx+adjs, setB, setB, 502, GumpButtonType.Reply, 0);
					AddHtml( 870, adjx+adjs, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Blue</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x48E ){ setB = 4018; } else { setB = 3609; }
					AddButton(960, adjx+adjs, setB, setB, 503, GumpButtonType.Reply, 0);
					AddHtml( 1000, adjx+adjs, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Red</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					adjs = adjs + adjm;
					adjx = adjx + adjc;

					if ( DB.MagerySpellHue == 0x48F ){ setB = 4018; } else { setB = 3609; }
					AddButton(570, adjx+adjs, setB, setB, 504, GumpButtonType.Reply, 0);
					AddHtml( 610, adjx+adjs, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Green</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x490 ){ setB = 4018; } else { setB = 3609; }
					AddButton(700, adjx+adjs, setB, setB, 505, GumpButtonType.Reply, 0);
					AddHtml( 740, adjx+adjs, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Purple</BIG></BASEFONT></BODY>", (bool)false, (bool)false);

					if ( DB.MagerySpellHue == 0x491 ){ setB = 4018; } else { setB = 3609; }
					AddButton(830, adjx+adjs, setB, setB, 506, GumpButtonType.Reply, 0);
					AddHtml( 870, adjx+adjs, 64, 20, @"<BODY><BASEFONT Color=#FCFF00><BIG>Yellow</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
			
					if ( DB.MagerySpellHue == 0 ){ setB = 4018; } else { setB = 3609; }
					AddButton(960, adjx+adjs, setB, setB, 507, GumpButtonType.Reply, 0);
					AddHtml( 1000, adjx+adjs, 64, 20, @"<BODY><BASEFONT Color=#FFA200><BIG>Default</BIG></BASEFONT></BODY>", (bool)false, (bool)false);
				}
			...
			if ( from.Region is HouseRegion )
			    if (((HouseRegion)from.Region).House.IsOwner(from))
					house = true;
			if ( from.Region.GetLogoutDelay( from ) != TimeSpan.Zero && house == false && !( from.Region is PrisonArea ) )
			{
		...
		public static string MyQuests( Mobile from )
        {
			...
			if ( CharacterDatabase.GetKeys( from, "DragonRiding" ) && Server.Misc.MyServerSettings.ClientVersion() ){ sQuests = sQuests + "-Learned the secrets of dragon riding.<br><br>"; }
