	...
	public class SythSpellbookGump : Gump 
	{
		...
		public SythSpellbookGump( Mobile from, SythSpellbook book, int page ) : base( 25, 25 ) 
		{
			...
			else if ( page == 6 )
			{
				...
				if ( !Server.Misc.GetPlayerInfo.isSyth ( from, false ) || from.Skills[SkillName.EvalInt].Value < 100 || from.Skills[SkillName.Tactics].Value < 100 || from.Skills[SkillName.Swords].Value < 100 || from.Fame < 15000 || from.Karma > -15000 )
				{ 
