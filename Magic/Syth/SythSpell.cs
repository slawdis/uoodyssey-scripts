...
namespace Server.Spells.Syth
{
	public abstract class SythSpell : Spell
	{
		...
		public override bool CheckCast()
		{
			...
			else if ( this is SythSpeed && Server.Misc.MyServerSettings.NoMountsInCertainRegions() && Server.Mobiles.AnimalTrainer.IsNoMountRegion( Caster, Region.Find( Caster.Location, Caster.Map ) ) )
			{
