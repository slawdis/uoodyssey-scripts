...
namespace Server.Spells.Jedi
{
	public abstract class JediSpell : Spell
	{
		...
		public override bool CheckCast()
		{
			...
			else if ( this is Celerity && Server.Misc.MyServerSettings.NoMountsInCertainRegions() && Server.Mobiles.AnimalTrainer.IsNoMountRegion( Caster, Region.Find( Caster.Location, Caster.Map ) ) )
			{
